...
// Query
$result = mysqli_query($mysqli, "SELECT * FROM tbl_barang WHERE nama_barang LIKE '$keyword' OR brand_barang LIKE '$keyword'");
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered mt-3">
                    ...
                    <tbody>
                        ...
                        <?php else : ?>
                            <tr>
                                <td class="text-center" scope="row" colspan="3"><?= "Data tidak ditemukan!" ?></td>
                            </tr>
                        <?php endif ?>
                    </tbody>
                </table>
